...
class Server:
    ...
    def create_media_data(self, id, name, season_id=None, season_number="", media_type=None, dir_name=None, offset=0, alt_id=None, cover=None):
        return dict(server_id=self.id, id=id, dir_name=dir_name if dir_name else re.sub(r"[\W]", "", name.replace(" ", "_")), name=name, media_type=media_type or self.media_type, cover=None, progress=0, season_id=season_id, season_number=season_number, offset=offset, chapters={}, alt_id=alt_id)
